...
default_paths = Paths(
    query_images='ShopFacade/',
    reference_images='ShopFacade/',
    reference_sfm='ShopFacade/sfm_superpoint+superglue/',
    query_list='ShopFacade/query_list_with_intrinsics.txt',
    retrieval_pairs='ShopFacade/pairs-query-netvlad10.txt',
    ground_truth='CambridgeLandmarks_Colmap_Retriangulated_1024px/ShopFacade/',
    results='pixloc_Cambridge_ShopFacade.txt',
)
